...
async def process_grade_batch_chats(
    ...
    *,
    ...
    Input rows require:
      ...
      - 5 predicted columns: CONTACT_TYPE, DOMAIN, SUBDOMAIN, ISSUE_ORIGIN
...
async def process_grade_batch_calls(
    pred_df_or_rows: Union[pd.DataFrame, List[Dict[str, Any]]],
    *,
    client: Any,
    deployment: str,
    ...
    Input rows require:
      - id_col (default CHAT_TRANSCRIPT_NAME)
      - text_col (default BODY)
      - 4 predicted columns: CONTACT_TYPE, DOMAIN, SUBDOMAIN, ISSUE_ORIGIN
